...
--
-- Host: localhost    Database: owlmapdb
-- ------------------------------------------------------
...
CREATE TABLE `maestros` (
  ...
  `cubiculo` varchar(7) DEFAULT NULL,
...
CREATE TABLE `puntos` (
  ...
  `tipo` enum('edificio','caseta','servicio','cubiculo') DEFAULT NULL,
  PRIMARY KEY (`clave`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `puntos` VALUES (29.0828752,-110.9617472,'Comedor Universitario','12d-1','servicio'),(29.0828752,-110.9617472,'Tesoreria','12d-2','servicio'),(29.0812894,-110.9601972,'Edificio de Ciencias de la Computacion','3k-4','edificio');
